...
<div id="login">
    ...
    <form action="/pedido/novo" method="post" class="card-cadastro">
        ...
        <div class="card-content">
            <div class="card-content-area">
                ...
                <input type="text" name="carrinho" value="PulseiraLisa">
            </div>
            <div class="card-content-area">
                <label>Codigo do Produto</label>
                <input type="text" name="codigoProduto" value="801">
            </div>
            <div class="card-content-area">
        ...
        <div class="card-footer">
            <button class="button-81" type="submit">Adionar</button>
        </div>
    </form>
